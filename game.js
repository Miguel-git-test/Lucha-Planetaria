...
// ---- LEVEL DEFINITIONS ----------------------------------------------------
const LEVELS = [
  { name:'ALPHA', hint:'Tap your planet, then tap another to send your fleet',
    enemies:[], diff:0,
    planets:[
      {xp:.15,yp:.5, r:30,owner:'player', lv:0,maxLv:0,u:20},
      {xp:.5, yp:.5, r:24,owner:'neutral',lv:0,maxLv:0},
      {xp:.83,yp:.5, r:24,owner:'neutral',lv:0,maxLv:0},
    ]},
  { name:'BETA', hint:'Send more units than the enemy to capture their planet',
    enemies:['enemy1'], diff:0,
    planets:[
      {xp:.12,yp:.5, r:30,owner:'player', lv:0,maxLv:1,u:20},
      {xp:.35,yp:.28,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.35,yp:.72,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.58,yp:.5, r:22,owner:'neutral',lv:0,maxLv:0},
      {xp:.85,yp:.5, r:30,owner:'enemy1', lv:0,maxLv:1,u:15},
    ]},
  { name:'GAMMA', hint:null,
    enemies:['enemy1'], diff:0,
    planets:[
      {xp:.11,yp:.5, r:28,owner:'player', lv:0,maxLv:1,u:15},
      {xp:.3, yp:.25,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.3, yp:.75,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.5, yp:.5, r:28,owner:'neutral',lv:0,maxLv:1},
      {xp:.7, yp:.28,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.7, yp:.72,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.89,yp:.5, r:28,owner:'enemy1', lv:0,maxLv:1,u:15},
    ]},
  { name:'DELTA', hint:null,
    enemies:['enemy1'], diff:1,
    planets:[
      {xp:.1, yp:.22,r:28,owner:'player', lv:0,maxLv:2,u:15},
      {xp:.1, yp:.78,r:22,owner:'neutral',lv:0,maxLv:0},
      {xp:.3, yp:.5, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.5, yp:.22,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.5, yp:.78,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.7, yp:.5, r:22,owner:'neutral',lv:0,maxLv:0},
      {xp:.9, yp:.22,r:28,owner:'enemy1', lv:1,maxLv:2,u:20},
      {xp:.9, yp:.78,r:22,owner:'neutral',lv:0,maxLv:0},
    ]},
  { name:'EPSILON', hint:null,
    enemies:['enemy1','enemy2'], diff:1,
    planets:[
      {xp:.1, yp:.5, r:30,owner:'player', lv:0,maxLv:2,u:20},
      {xp:.28,yp:.22,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.28,yp:.78,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.5, yp:.5, r:26,owner:'neutral',lv:0,maxLv:1},
      {xp:.7, yp:.22,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.7, yp:.78,r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.88,yp:.25,r:28,owner:'enemy1', lv:0,maxLv:2,u:15},
      {xp:.88,yp:.75,r:28,owner:'enemy2', lv:0,maxLv:2,u:15},
    ]},
  { name:'ZETA', hint:null,
    enemies:['enemy1','enemy2'], diff:1,
    planets:[
      {xp:.1, yp:.5, r:28,owner:'player', lv:0,maxLv:2,u:15},
      {xp:.25,yp:.2, r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.25,yp:.8, r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.4, yp:.5, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.55,yp:.2, r:20,owner:'neutral',lv:0,maxLv:1},
      {xp:.55,yp:.8, r:20,owner:'neutral',lv:0,maxLv:1},
      {xp:.7, yp:.5, r:22,owner:'neutral',lv:0,maxLv:0},
      {xp:.87,yp:.3, r:28,owner:'enemy1', lv:1,maxLv:2,u:20},
      {xp:.87,yp:.7, r:28,owner:'enemy2', lv:1,maxLv:2,u:20},
    ]},
  { name:'ETA', hint:null,
    enemies:['enemy1','enemy2'], diff:2,
    planets:[
      {xp:.1, yp:.5, r:30,owner:'player', lv:1,maxLv:3,u:25},
      {xp:.22,yp:.25,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.22,yp:.75,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.38,yp:.5, r:26,owner:'neutral',lv:0,maxLv:2},
      {xp:.55,yp:.2, r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.55,yp:.8, r:20,owner:'neutral',lv:0,maxLv:0},
      {xp:.55,yp:.5, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.75,yp:.25,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.75,yp:.75,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.9, yp:.35,r:30,owner:'enemy1', lv:1,maxLv:3,u:25},
      {xp:.9, yp:.65,r:30,owner:'enemy2', lv:1,maxLv:3,u:25},
    ]},
  { name:'THETA', hint:null,
    enemies:['enemy1','enemy2'], diff:2,
    planets:[
      {xp:.08,yp:.5, r:32,owner:'player', lv:1,maxLv:3,u:30},
      {xp:.2, yp:.2, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.2, yp:.8, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.33,yp:.5, r:26,owner:'neutral',lv:0,maxLv:2},
      {xp:.47,yp:.2, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.47,yp:.8, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.47,yp:.5, r:28,owner:'neutral',lv:1,maxLv:2},
      {xp:.62,yp:.3, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.62,yp:.7, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.75,yp:.5, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.9, yp:.3, r:32,owner:'enemy1', lv:1,maxLv:3,u:30},
      {xp:.9, yp:.7, r:32,owner:'enemy2', lv:1,maxLv:3,u:30},
    ]},
  { name:'IOTA', hint:'Upgrade speed is key to dominance.',
    enemies:['enemy1'], diff:2,
    planets:[
      {xp:.1, yp:.5, r:34,owner:'player', lv:1,maxLv:3,u:35},
      {xp:.3, yp:.25,r:22,owner:'neutral',lv:1,maxLv:1},
      {xp:.3, yp:.75,r:22,owner:'neutral',lv:1,maxLv:1},
      {xp:.5, yp:.5, r:30,owner:'neutral',lv:1,maxLv:2},
      {xp:.75,yp:.5, r:26,owner:'neutral',lv:0,maxLv:1},
      {xp:.9, yp:.5, r:34,owner:'enemy1', lv:2,maxLv:3,u:40},
    ]},
  { name:'KAPPA', hint:'A multi-front war awaits.',
    enemies:['enemy1','enemy2'], diff:2,
    planets:[
      {xp:.2, yp:.2, r:28,owner:'player', lv:1,maxLv:3,u:30},
      {xp:.2, yp:.8, r:28,owner:'enemy1', lv:1,maxLv:3,u:30},
      {xp:.8, yp:.5, r:28,owner:'enemy2', lv:1,maxLv:3,u:30},
      {xp:.5, yp:.5, r:32,owner:'neutral',lv:1,maxLv:3},
      {xp:.4, yp:.25,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.4, yp:.75,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.6, yp:.35,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.6, yp:.65,r:22,owner:'neutral',lv:0,maxLv:1},
    ]},
  { name:'LAMBDA', hint:null,
    enemies:['enemy1','enemy2'], diff:2,
    planets:[
      {xp:.15,yp:.5, r:26,owner:'player', lv:1,maxLv:3,u:20},
      {xp:.4, yp:.2, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.4, yp:.8, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.5, yp:.5, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.6, yp:.2, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.6, yp:.8, r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.85,yp:.3, r:26,owner:'enemy1', lv:1,maxLv:3,u:20},
      {xp:.85,yp:.7, r:26,owner:'enemy2', lv:1,maxLv:3,u:20},
    ]},
  { name:'MU', hint:'The void between stars is harsh.',
    enemies:['enemy1'], diff:2,
    planets:[
      {xp:.08,yp:.2, r:30,owner:'player', lv:1,maxLv:3,u:30},
      {xp:.08,yp:.8, r:20,owner:'neutral',lv:0,maxLv:1},
      {xp:.5, yp:.5, r:40,owner:'neutral',lv:1,maxLv:3},
      {xp:.92,yp:.2, r:20,owner:'neutral',lv:0,maxLv:1},
      {xp:.92,yp:.8, r:30,owner:'enemy1', lv:2,maxLv:3,u:35},
    ]},
  { name:'NU', hint:null,
    enemies:['enemy1','enemy2'], diff:2,
    planets:[
      {xp:.5, yp:.15,r:32,owner:'player', lv:1,maxLv:3,u:25},
      {xp:.15,yp:.6, r:28,owner:'enemy1', lv:1,maxLv:3,u:25},
      {xp:.85,yp:.6, r:28,owner:'enemy2', lv:1,maxLv:3,u:25},
      {xp:.35,yp:.4, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.65,yp:.4, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.5, yp:.8, r:24,owner:'neutral',lv:0,maxLv:2},
    ]},
  { name:'XI', hint:'Symmetry is the mother of strategy.',
    enemies:['enemy1'], diff:3,
    planets:[
      {xp:.1, yp:.25,r:26,owner:'player', lv:1,maxLv:3,u:20},
      {xp:.1, yp:.75,r:26,owner:'player', lv:0,maxLv:2,u:10},
      {xp:.3, yp:.5, r:28,owner:'neutral',lv:0,maxLv:2},
      {xp:.5, yp:.25,r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.5, yp:.75,r:24,owner:'neutral',lv:0,maxLv:1},
      {xp:.7, yp:.5, r:28,owner:'neutral',lv:0,maxLv:2},
      {xp:.9, yp:.25,r:26,owner:'enemy1', lv:1,maxLv:3,u:20},
      {xp:.9, yp:.75,r:26,owner:'enemy1', lv:0,maxLv:2,u:10},
    ]},
  { name:'OMICRON', hint:null,
    enemies:['enemy1','enemy2'], diff:3,
    planets:[
      {xp:.5, yp:.5, r:36,owner:'neutral',lv:2,maxLv:3,u:50},
      {xp:.15,yp:.15,r:28,owner:'player', lv:1,maxLv:3,u:30},
      {xp:.15,yp:.85,r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.85,yp:.15,r:28,owner:'enemy1', lv:1,maxLv:3,u:30},
      {xp:.85,yp:.85,r:28,owner:'enemy2', lv:1,maxLv:3,u:30},
    ]},
  { name:'PI', hint:'The final frontier of manual combat.',
    enemies:['enemy1','enemy2'], diff:3,
    planets:[
      {xp:.1, yp:.5, r:30,owner:'player', lv:1,maxLv:3,u:40},
      {xp:.3, yp:.3, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.3, yp:.7, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.5, yp:.5, r:32,owner:'neutral',lv:1,maxLv:3},
      {xp:.7, yp:.3, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.7, yp:.7, r:22,owner:'neutral',lv:0,maxLv:1},
      {xp:.9, yp:.25,r:30,owner:'enemy1', lv:2,maxLv:3,u:35},
      {xp:.9, yp:.75,r:30,owner:'enemy2', lv:2,maxLv:3,u:35},
    ]},
];
...
class Game {
  ...
  _onTap(x, y) {
    ...
    // Find tapped planet
    const tapped = this.planets.find(p => dist(x,y,p.x,p.y) < p.r * 1.3);
